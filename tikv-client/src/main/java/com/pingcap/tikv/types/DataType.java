...
public abstract class DataType implements Serializable {
  ...
  // TODO(Zhexuan Yang) need port this check form tidb
  //
  // https://github.com/pingcap/tidb/blob/c8d1ff7ca66f6e98d2002c429addf5ba34fd0416/expression/expr_to_pb.go#L205
  /*
   * return true if this type can be pushed down to TIKV or TIFLASH
   * */
  public abstract boolean isSupportPushDown();
