...
import static com.pingcap.tikv.operation.iterator.CoprocessorIterator.getTiColumnarChunkIterator;
...
public class Snapshot {
  ...
  public Iterator<TiColumnarChunk> tableReadChunk(TiDAGRequest dagRequest, List<RegionTask> tasks) {
    if (dagRequest.isDoubleRead()) {
      ...
      return getTiColumnarChunkIterator(dagRequest, tasks, getSession());
    }
  }
  /**
